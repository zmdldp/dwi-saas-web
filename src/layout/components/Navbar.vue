    ...
    <div class="right-menu">
      ...
      >
        ...
        <el-dropdown-menu slot="dropdown">
          ...
          <a
            target="_blank"
            href="https://github.com/zuihou/saas-cloud"
          >
            <el-dropdown-item>{{ $t("navbar.github") }}</el-dropdown-item>
          </a>
          <a
            target="_blank"
            href="https://www.kancloud.cn/zuihou/saas-cloud/"
          >
...
export default {
  ...
  data() {
    return {
      tips: ' 演示环境禁止修改、删除重要数据！请登录租户【0000】，账号【saas_pt】查询其他租户的管理员账号后，登录其他租户测试全部功能!!! ',
      tableData: {
        total: 0,
        records: []
      },
