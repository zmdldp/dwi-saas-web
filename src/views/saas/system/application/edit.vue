  ...
  export default {
    ...
    data() {
      return {
        ...
        serviceList: [
          {id: "saas-authority-server", name: "权限服务"},
          {id: "saas-file-server", name: "文件服务"},
          {id: "saas-msg-server", name: "消息服务"},
          {id: "saas-demo-server", name: "演示服务"},
          {id: "saas-order-server", name: "订单服务"},
        ]
      }
    },
    computed: {
