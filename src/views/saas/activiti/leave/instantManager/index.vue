<template>
  <div class="app-container">
    ...
    >
      ...
      <el-table-column
        :label="$t('table.instantModel.type')"
        :show-overflow-tooltip="true"
        align="center"
        width="100px"
      >
      ...
      <el-table-column
        :label="$t('table.instantModel.isOver')"
        :show-overflow-tooltip="true"
        align="center"
        width="100px"
      >
      ...
      <el-table-column
        :label="$t('table.instantModel.suspendStateName')"
        :show-overflow-tooltip="true"
        align="center"
        width="100px"
      >
...
export default {
  ...
  methods: {
    fetch(params = {}) {
      ...
      activitiApi.pageInstant(this.queryParams).then(response => {
